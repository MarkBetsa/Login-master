...
public class Login extends AppCompatActivity {
    ...
    private final String mFileName = "User.txt";
    ...
    public void btnLogin(View view) {
        ...
        String E;
        String P;
        for(j=0;i==0;intindex1 = str.indexOf("email",intindex1+1)){
            if ((intindex1 == 0)&&j!=0) { loginButton.setClickable(false);}
            intindex2=str.indexOf("!",intindex1);
            E = str.substring(intindex1+7,intindex2);
            if(email.equals(E)){
                P = str.substring(intindex2+12,str.indexOf("!",intindex2+1));
